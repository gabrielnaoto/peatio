  ...
  module Daemons
    class Blockchain < Base
      ...
      def process(bc)
        ...
        while running
          begin
            bc_service.fetch_latest_block

            if bc.reload.height + bc.min_confirmations >= bc_service.latest_block
              logger.info { "Skip synchronization. No new blocks detected, height: #{bc.height}, latest_block: #{bc_service.latest_block}." }
            ...
            (from_block..bc_service.latest_block).each do |block_id|
